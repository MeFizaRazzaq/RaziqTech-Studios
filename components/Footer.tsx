    ...
    <footer className="bg-navy text-neutral-coolgray pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-3 mb-8">
              <Rocket className="w-8 h-8 text-ice" />
              <span className="text-3xl font-black text-white tracking-tighter">RaziqTech</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 font-medium">
              ...
              <li><Link to="/services" className="hover:text-ice transition-soft">Mobile Ecosystems</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 font-medium">
              ...
              <li><Link to="/portfolio" className="hover:text-ice transition-soft">Case Portfolio</Link></li>
        ...
        <div className="border-t border-white/5 pt-12 flex flex-col md:flex-row justify-between items-center text-sm font-semibold">
          <p>© 2024 RaziqTech Studios Inc. Engineering Excellence Worldwide.</p>
